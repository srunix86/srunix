...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (GCC) 14.2.1 20250207'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=X86_64_EFI -m64 -nostdinc -isystem /usr/lib/gcc/x86_64-pc-linux-gnu/14.2.1/include -I$(top_srcdir)/include -I$(top_builddir)/include'
...
grub_version="2.13"
grub_package="grub"
grub_package_string="GRUB 2.13"
grub_package_version="2:2.12.r260.gaae2ea61-1"
